...
impl Day3State {
    pub fn new() -> Self {
        let question = "In what year was the first christmas celebrated?".to_string();
        let correct_answer = "336 CE".to_string();
        let wrong_answers = ["1", "223 BCE"];
